...
ActiveRecord::Schema.define(:version => 20140623120832) do
  ...
  add_index "certifications", ["slug"], :name => "index_certifications_on_slug"
  ...
  add_index "testimonies", ["slug"], :name => "index_testimonies_on_slug"
